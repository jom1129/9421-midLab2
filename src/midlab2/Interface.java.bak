...
// TODO: 10/30/2021 @Clarence
// Revise the previous GUI to work
// GUI Class
...
public class Interface {
    ...
    StringBuilder stack;   // Local stack variable
    ...
    private String[] conversionType = { "Text to Huffman Code Conversion", "Huffman Code to Text Conversion" };
    ...
    private JComponent[] upperPanelComponents = { new JLabel("Input: "), input, submit };
    private JComponent[] expressionPanelComponents = { new JLabel("Conversion Type: "),
    ...
    public Interface() {
        ...
        labelPanel.add(new JLabel("Text-Huffman Utility"));
        ...
        submit.addActionListener((ActionEvent e) -> {
            try {
                stack = Utility.acceptInput(input.getText());
                if (expressionType.getSelectedIndex() == 0) Utility.huffmanToText(stack);
                else Utility.showHuffmanTable(stack);
                ...
                JOptionPane.showMessageDialog(null,
                        "Invalid input or wrong conversion type selected.");
                tableText.setText(null);
            }
        });
        // Clear the text pane
